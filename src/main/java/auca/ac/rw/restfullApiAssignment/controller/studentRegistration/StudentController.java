...
public class StudentController {
    ...
    public StudentController() {
        ...
        students.add(new Student(2L, "Jane", "Smith", "jane@example.com", "Computer Science", 3.5));
        ...
        students.add(new Student(5L, "Tom", "Brown", "tom@example.com", "Computer Science", 3.6));
    }
